...
const SQUARES: Square[] = [
  ...
  { id: 6, action: "Susurro picante al oído." },
  { id: 7, action: "Reto: Quítate una prenda de ropa." },
  { id: 8, action: "¡Suerte! Avanza 2 casillas.", type: 'forward', target: 10 },
  { id: 9, action: "Un beso francés apasionado." },
  { id: 10, action: "Caricias lentas en la espalda." },
  ...
  { id: 13, action: "Beso tierno en la oreja." },
  { id: 14, action: "¡Resbalón! Baja a la casilla 4.", type: 'snake', target: 4 },
  { id: 15, action: "Baile sensual durante 30 segundos." },
  { id: 16, action: "Beso juguetón en el ombligo." },
  { id: 17, action: "¡Bonus! Avanza 3 casillas.", type: 'forward', target: 20 },
  { id: 18, action: "Masaje placentero en los pies." },
  { id: 19, action: "¡Cuidado! Baja a la casilla 9.", type: 'snake', target: 9 },
  { id: 20, action: "Reto: Elige entre Verdad o Atrevimiento." },
  { id: 21, action: "Beso delicado en los párpados." },
  { id: 22, action: "Caricias sugerentes en los muslos." },
  ...
  { id: 26, action: "Beso prolongado en las manos." },
  { id: 27, action: "Reto: 1 minuto de mimos sin parar." },
  ...
  { id: 30, action: "¡META! Has ganado un premio a tu elección." },
];
