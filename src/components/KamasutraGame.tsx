...
export function KamasutraGame({ onBack }: { onBack: () => void }) {
  ...
  const availablePositions = POSITIONS.filter(
    (p) => !shownPositions.includes(p.name),
  );
    ...
    <div className="max-w-4xl mx-auto p-6 min-h-screen flex flex-col">
      <header className="flex justify-between items-center mb-12">
        ...
        <div className="flex flex-col items-center">
          <h2 className="text-2xl font-bold italic serif">
        ...
        <AnimatePresence mode="wait">
          {availablePositions.length === 0 && !isRolling ? (
            ...
            >
              ...
              <h3 className="text-2xl font-bold italic serif mb-2">
                ¡Has descubierto todas!
              </h3>
              <p className="text-stone-500 mb-6">
                Reinicia para volver a empezar el ciclo.
              </p>
              <button
                onClick={reset}
            ...
            >
              ...
              <p className="text-stone-400 font-medium italic">
                Presiona el botón para descubrir una posición
              </p>
            </motion.div>
          )}
        </AnimatePresence>
